...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(choices=[('atmosphere', 'Atmosphere'), ('flare', 'Flare'), ('closed_process', 'Closed Process')], default='atmosphere', max_length=25)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(choices=[('mild', 'Mild'), ('moderate', 'Moderate'), ('severe', 'Severe')], default='mild', max_length=15)),
            ],
        ),
        migrations.CreateModel(
            name='TypeOfPRD',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(choices=[('convention_spring_loaded', 'Convention Spring-Loaded'), ('balanced_bellows', 'Balanced Bellows'), ('pilot_operated', 'Pilot Operated'), ('Rupture_disk_only', 'Rupture Disk Only')], default='convention_spring_loaded', max_length=30)),
            ],
        ),
        migrations.CreateModel(
            name='SelectField',
